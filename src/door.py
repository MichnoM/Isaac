...
door_sprites = pygame.image.load('sprites/doors/doors.png')
door_spritesheet = spritesheet.SpriteSheet(door_sprites)
treasure_door = pygame.image.load("sprites/doors/treasureDoors.png")
treasure_door = pygame.transform.scale(treasure_door, (51*2, 40*2))
boss_door = pygame.image.load("sprites/doors/bossDoors.png")
